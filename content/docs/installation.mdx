...
<Callout type="warn">
Swapping between pyrodcatyl and Pterodactyl is not recommned or supported. We've added database migrations making it unlikely Pterodactyl will work when swapping back to it.
Take a backup of your db if you care about it's validity!
