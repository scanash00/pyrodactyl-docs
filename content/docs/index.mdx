...
<Callout type="info">
There are plans to make Pyrodactyl's installation as seamless as possible, we are currently working on an installation script, to make Pyrodactyl's installation as easy as it can be.
</Callout>
