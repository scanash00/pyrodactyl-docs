...
<Callout title="Installation Update" type="info">
  We are currently working on an installation script to make Pyrodactyl's setup as seamless and easy as possible.
</Callout>
