				...
				<div className="relative mx-auto flex h-full w-full container flex-col items-center px-6">
					...
					<div className="z-10 mx-auto mt-12 flex h-full w-full flex-col items-center justify-between gap-8 lg:flex-row lg:gap-0">
						...
						<div className="flex w-full flex-col gap-8 lg:w-1/3 lg:gap-4">
							...
							<PyroButton variant="secondary" href="https://github.com/pyrohost/pyrodactyl">
								Star on GitHub
							</PyroButton>
						</div>
					</div>
					...
					<div className="grid grid-cols-1 gap-12 md:grid-cols-3">
						<div className="col-span-1">
							<div className="flex flex-col gap-1">
								...
								<span className="text-gray-600 dark:text-gray-300">Pyrodactyl is built with Vite, the fastest and most reliable build tool for JavaScript.</span>
							</div>
						</div>
						<div className="col-span-1">
							<div className="flex flex-col gap-1">
								<span className="font-bold text-brand text-lg">Accessibility at the core</span>
								<span className="text-gray-600 dark:text-gray-300">Pyro is commited to making our software accessible to everyone. Pyrodactyl is no exception.</span>
							</div>
						</div>
						<div className="col-span-1">
							<div className="flex flex-col gap-1">
								<span className="font-bold text-brand text-lg">Optimized to pieces</span>
								<span className="text-gray-600 dark:text-gray-300">Pyrodactyl builds in less than 150 milliseconds, and renders up to 70% faster than the original panel.</span>
							</div>
						</div>
						<div className="col-span-1">
							<div className="flex flex-col gap-1">
								<span className="font-bold text-brand text-lg">Modern, scalable, and secure</span>
								<span className="text-gray-600 dark:text-gray-300">The only outdated aspect of Pyrodactyl is the name. Everything else is absolutely cutting-edge.</span>
							</div>
						</div>
						<div className="col-span-1">
							<div className="flex flex-col gap-1">
								<span className="font-bold text-brand text-lg">Batteries included</span>
								<span className="text-gray-600 dark:text-gray-300">It's everything you need, out-of-the-box. There's no need to install plugins or themes.</span>
							</div>
						</div>
						<div className="col-span-1">
							<div className="flex flex-col gap-1">
								<span className="font-bold text-brand text-lg">Open source</span>
								<span className="text-gray-600 dark:text-gray-300">Pyrodactyl is the first (and only) panel that a company has made its source publicly available.</span>
							</div>
						</div>
					</div>
